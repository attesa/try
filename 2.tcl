...
set output [open "holet300_wjnamd4_671.csv" w]
set output1 [open "holet300_wjnamd4_679.csv" w]
set output2 [open "holet300_wjnamd4_643.csv" w]
set outputg [open "holet300_wjnamd4_global.csv" w]
#set output file 

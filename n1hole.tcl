...
set output [open "namd2t330_hole_671.csv" w]
set output1 [open "namd2t330_hole_679.csv" w]
set output2 [open "namd2t330_hole_643.csv" w]
set outputg [open "namd2t330_hole_global.csv" w]
#set output file 

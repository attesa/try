...
set selection [atomselect top "resid 656 to 670 and segname PROD and name CA"]
set selection1 [atomselect top "resid 674 to 686 and segname PROD and name CA"]
set total_sel [atomselect top "resid 656 to 686 and segname PROD and name CA"]
#set selection [atomselect top "all and name CA"]
#modify for your choice
set mol_id [$selection molindex]
set angle_out [open "testD.csv" w]

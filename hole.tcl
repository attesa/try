...
namespace eval Hole {
  ...
  # the radius file.
  variable holebin /user/hanwen/hole2/exe/hole
  variable holerad /user/hanwen/hole2/rad/simple.rad
  
  #variable holerad /user/hanwen/hole2/rad/ca.rad
  ...
  #variable cpoint [list 80. 80. 62.]
  #martini
  variable cpoint [list 0. 0. -1.]
  #Allatom

...
set selection [atomselect top "not name 'H.*'"]
set output [open "1027_p5ht303_671.csv" w]
set output1 [open "1027_p5ht303_679.csv" w]
set output2 [open "1027_p5ht303_643.csv" w]
set output3 [open "1027_p5ht303_lower.csv" w]
set outputg [open "1027_p5ht303_global.csv" w]
set output4 [open "1027_p5ht303_upper.csv" w]

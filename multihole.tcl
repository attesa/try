...
set output [open "merge_10hole_671.csv" w]
set output1 [open "merge_10hole_679.csv" w]
set output2 [open "merge_10hole_643.csv" w]
set output3 [open "merge_10hole_lower.csv" w]
set outputg [open "merge_10hole_global.csv" w]
set output4 [open "merge_10hole_upper.csv" w]

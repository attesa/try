...
#change the method to determine lower and upper gate, by determining the mid point of CA of 643,679
#11/4/2015
...
set up_res [atomselect top "resid 643 and name CA"]
set low_res [atomselect top "resid 679 and name CA"]

set output [open "06_25_16_qccr7_671.csv" w]
set output1 [open "06_25_16_qccr7_679.csv" w]
set output2 [open "06_25_16_qccr7_643.csv" w]
set output3 [open "06_25_16_qccr7_lower.csv" w]
set outputg [open "06_25_16_qccr7_global.csv" w]
set output4 [open "06_25_16_qccr7_upper.csv" w]
...
#    for {set j 0} {$j < 10} {incr j 1} {
	...
	set z_out4 -1000
    	...
    	#
    	#
    	#Determine z_middle for lower and upper


	set z_up [lindex [measure center $up_res] 2]
	set z_low [lindex [measure center $low_res] 2]
	set z_mid [expr {($z_low+$z_up)/2}]

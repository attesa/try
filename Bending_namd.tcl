...
set selection [atomselect top "resid 656 to 672 and segname PROA and name CA"]
set selection1 [atomselect top "resid 674 to 686 and segname PROA and name CA"]
#set selection [atomselect top "resid 656 to 663 and chain A and name CA C N"]
#set selection1 [atomselect top "resid 663 to 673 and chain A and name CA C N"]
#set selection [atomselect top "all and name CA"]
#modify for your choice
set mol_id [$selection molindex]
set angle_out [open "testol.csv" w]

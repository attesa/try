...
#set selection [atomselect top "resid 630 to 642 and chain A and name CA"]
set selection [atomselect top "all and z > -25 and name CA"]
#modify for your choice
set mol_id [$selection molindex]
set angle_out [open "s6_A.dat" w]
...
#Loop for all frames
    ...
    set principal_axis "[lindex $I_matrix 3] [lindex $I_matrix 6] [lindex $I_matrix 9]"
    #puts $principal_axis
    #puts [show $eigenvalue]
    set x_v [lindex $I_matrix 3]
    set y_v [lindex $I_matrix 6]
    set z_v [lindex $I_matrix 9]

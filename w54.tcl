...
#Modified to give the sign of bending angle
#######################
#For the normalized vectors, if v1z>v2z the angle is postive
...
set selection [atomselect top "resid 656 to 670 and segname PROA and name CA"]
set selection1 [atomselect top "resid 674 to 686 and segname PROA and name CA"]
set total_sel [atomselect top "resid 656 to 686 and segname PROA and name CA"]
#set selection [atomselect top "all and name CA"]
#modify for your choice
set mol_id [$selection molindex]
set angle_out [open "ima_S6b_670to674_qnamd5_A.csv" w]

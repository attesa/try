...
set output [open "820merge_pft303_1to11__671.csv" w]
set output1 [open "820merge_pft303_1to11__679.csv" w]
set output2 [open "820merge_pft303_1to11__643.csv" w]
set outputg [open "820merge_pft303_1to11__global.csv" w]
#set output file 

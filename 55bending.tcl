...
set selection [atomselect top "resid 656 to 683 and segname PROA and name CA"]
set selection1 [atomselect top "resid 691 to 711 and segname PROA and name CA"]
set total_sel [atomselect top "resid 683 to 691 and segname PROA and name CA"]
#set selection [atomselect top "all and name CA"]
#modify for your choice
set mol_id [$selection molindex]
set angle_out [open "bendingtrp6_biownamd1t330_683691_A.csv" w]
...
#Loop for all frames
    ...
    #The normal vector for polar plane will be (-cy,cx,0)
    ...
    set cos_theta_p1 [expr { ($z1_pnor*$z1_pnor-1)/($cx*$cx/$cy*$cy+1) + ($z1_pnor*$z1_pnor-1)/($cy*$cy/$cx*$cx+1) + $z1_pnor*$z1_pnor }]
    set cos_theta_p2 [expr { ($z2_pnor*$z2_pnor-1)/($cx*$cx/$cy*$cy+1) + ($z2_pnor*$z2_pnor-1)/($cy*$cy/$cx*$cx+1) + $z2_pnor*$z2_pnor }]
